...
const GiftBoxLoader: React.FC = () => (
  <div className="flex flex-col items-center justify-center py-12 animate-fade-in-up">
    <div className="relative flex items-center justify-center">
      ...
      {/* Bow */}
      <svg
        className="absolute -top-6 left-1/2 -translate-x-1/2 w-16 h-10 z-30"
        viewBox="0 0 64 40"
        fill="none"
      >
        <ellipse
    ...
    <div className="mt-8 text-lg font-semibold text-pink-500 animate-fade-in-up">
      Finding the perfect gifts for you...
    </div>
    <div className="text-sm text-slate-500 mt-2 animate-fade-in">
