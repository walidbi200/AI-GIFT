    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* "Why we love this" section */}
          <div className="bg-purple-50 dark:bg-purple-900/20 border-l-4 border-purple-400 dark:border-purple-600 p-3 rounded-r-lg mb-6">
            <p className="text-sm text-purple-800 dark:text-purple-200 font-medium">
              <span className="font-bold">Why we love this:</span> {suggestion.reason}
            </p>
          </div>
