...
export const useGoogleAnalytics = () => {
  ...
  const trackGiftGeneration = (occasion: string, relationship: string, interestsCount: number) => {
    trackEvent('gift_generation', 'engagement', `${occasion}_${relationship}`, interestsCount);
  };
