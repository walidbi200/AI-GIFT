...
export class GiftService {
  static async generateGiftSuggestions(formData: FormData): Promise<GiftSuggestion[]> {
    try {
      ...
      console.error('Error calling gift API:', error)
  ...
  static async generateMockSuggestions(formData: FormData): Promise<GiftSuggestion[]> {
    // Simulate API delay
