export const schemaMarkup = {
  ...
  organization: () => ({
    ...
    description:
      'AI-powered gift recommendation platform helping you find the perfect gift for any occasion',
    foundingDate: '2025',
    sameAs: [
  ...
  article: (data: {
    ...
    image:
      data.image || 'https://www.smartgiftfinder.xyz/smart-gift-finder-og.jpg',
    author: {
      '@type': 'Organization',
      name: 'Smart Gift Finder',
    },
